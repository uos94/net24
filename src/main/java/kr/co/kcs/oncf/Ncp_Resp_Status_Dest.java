...
import kr.co.kcs.oncf.ncp_resp_status_dest.Providers;
import com.hpe.nonstop.ddl2bean.commons.annotations.DdlField;
import com.hpe.nonstop.ddl2bean.commons.annotations.DdlGroup;

@DdlGroup(Version = "2.0", QualName = "ncp-resp-status-dest", ElementSize = 3252, LocalName = "ncp-resp-status-dest")
public class Ncp_Resp_Status_Dest
    implements Serializable
{
    ...
    private Providers[] providers = new Providers[ 100 ] ;
    ...
    @DdlField(Version = "2.0", QualName = "providers", ObjectClass = 0, Level = 1, Structure = 0, Offset = 48, ElementSize = 32, IdentifierElement = 16, OccursMax = 100)
    ...
    @DdlField(Version = "2.0", QualName = "queue-state", ObjectClass = 1, Level = 1, Structure = 2, Offset = 3248, ElementSize = 2, IdentifierElement = 24)
    ...
    @DdlField(Version = "2.0", QualName = "sba-bsi-service", ObjectClass = 1, Level = 1, Structure = 2, Offset = 3250, ElementSize = 2, IdentifierElement = 25)
