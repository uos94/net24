    ...
    implements Serializable
{
    ...
    @DdlField(Version = "2.0", QualName = "reserved", ObjectClass = 1, Level = 2, Structure = 0, Offset = 22, ElementSize = 16, IdentifierElement = 13)
    ...
    @DdlField(Version = "2.0", QualName = "bytelen", ObjectClass = 1, Level = 2, Structure = 2, Offset = 38, ElementSize = 2, IdentifierElement = 14)
    ...
    @DdlField(Version = "2.0", QualName = "value-var1", ObjectClass = 1, Level = 2, Structure = 0, Offset = 40, ElementSize = 200, IdentifierElement = 15)
