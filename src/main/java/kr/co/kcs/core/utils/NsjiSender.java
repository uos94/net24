...
import com.hpe.nonstop.ddl2bean.codegen.DdlInfoTree;
import com.hpe.nonstop.ddl2bean.io.Ddl2BeanObjectInputStream;
import com.hpe.nonstop.ddl2bean.io.Ddl2BeanObjectInputStreamLite;
import com.hpe.nonstop.ddl2bean.io.Ddl2BeanObjectOutputStream;
import com.hpe.nonstop.ddl2bean.io.DdlInfoTreeNode;
import com.hpe.nonstop.ddl2bean.io.DdlValue;
	...
	private byte[] socketSender(byte[] outByte) {
		...
		try{
			...
			if(isDataLen > 0){
			    ...
			    System.err.println("message (Hex) ::::::::::::::: " + hexString.toString());
			    System.err.println("message (String) ::::::::::::::: " + new String(inByte));
			    ...
			    System.err.println("message (Hex) ::::::::::::::: " + hexString2.toString());
			    System.err.println("message (String) ::::::::::::::: " + new String(rsByte));
			}
